      ...
      <main style={{ marginBottom: "4500px" }}>
            ...
            <div className="hero-news">
              <div style={{ width: "50vw" }} className="hero-news-block">
                ...
                <h3 style={{ fontWeight: "bold" }}>
                  {" "}
                  FROM VIRTUAL SIMULATION TO THE TRACK: THE REAL RACE BECOMES
                  REAL
                </h3>
                <button style={{ border: ".8px solid rgba(0,0,0,.5)" }}>
                  READ MORE
                </button>
              </div>
              ...
              <div style={{ width: "51vw" }} className="hero-news-block">
                ...
                <h3 style={{ fontWeight: "bold" }}>
                  LAMBORGHINI SUPER TROFEO EUROPE: LOCAL STAR BONDUEL TAKES
                  FIRST VICTORY AT SPA
                </h3>
                <button style={{ border: ".8px solid rgba(0,0,0,.5)" }}>
                  READ MORE
                </button>
        ...
        <div className="box">
          <div className="sec2-right">
            <h2>SQUADRA CORSE</h2>
            <p style={{ lineHeight: "25px", color: "rgba(0,0,0,.6)" }}>
              ...
              world are designed and produced in-house by Squadra Corse. It also
        ...
        <section className="sec3">
          <div className="sec3-text">
            ...
            <p style={{ color: "rgba(0,0,0,.6)", lineHeight: "25px" }}>
              Passion, performance and innovation. The Lamborghini Super Trofeo
              has <br /> been the pinnacle of the global one-make championship
              scene since 2009. <br /> The Super Trofeo is exclusively for
              Huracán Super Trofeo Evo model <br /> vehicles, which are racing
              versions of the road-approved supercars. There <br /> are three
              different series, in three continents: America, Asia and Europe.{" "}
              <br /> Every series consists of six rounds, each of which feature
              free practice <br /> sessions, qualifying and two races lasting 50
              minutes each. There are four <br /> categories of drivers: Pro,
              Pro-Am, Am and Lamborghini Cup. The season <br /> culminates in
              the World Final, when the Lamborghini world champions are crowned.
            </p>
            ...
            <div className="textAfterImages">
              ...
              <p style={{ color: "rgba(0,0,0,.6)", lineHeight: "25px" }}>
                In contrast with the Super Trofeo, GT3 championships are open to
                a range <br /> of constructors. There are more than 20
                Automobili Lamborghini customer <br /> teams who have chosen to
                compete in Huracán GT3 EVO race cars. Since <br /> the Huracán
                GT3 launch in 2015, the cars have claimed more than 40 titles{" "}
                <br /> on a global scale. What better calling card could there
                be for Automobili <br /> Lamborghini on the GT racing scene?
              </p>
        ...
        <section className="sec4">
          <div className="sec4-text">
            ...
            <p style={{ color: "rgba(0,0,0,.6)", lineHeight: "25px" }}>
              Lamborghini Squadra Corse’s cars for motorsport customers <br />{" "}
              are designed and produced in-house. The construction <br />{" "}
              approach used in Automobili Lamborghini supercars is also <br />{" "}
              applied to race models. Concepts such as superior technology{" "}
              <br /> and attention to detail are taken to peerless heights for{" "}
              <br /> customers who compete on race tracks all over the world.
            </p>
          ...
          <div className="sec4-text-2">
            <h2>EXPERIENCE</h2>
            <p style={{ color: "rgba(0,0,0,.6)", lineHeight: "25px" }}>
              Become a Lamborghini Super Trofeo driver thanks to <br /> the
              official Lamborghini Pilota driving course, or <br /> enjoy the
              exclusive experience of a Super Trofeo race <br /> weekend in the
              glamorous atmosphere of <br /> Lamborghini Hospitality.
            </p>
